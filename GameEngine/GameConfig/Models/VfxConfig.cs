...
public class VfxConfig
{
    ...
    public float HitstopGrenade     { get; set; } = 0.06f;
    public float HitstopBigFracture { get; set; } = 0.04f;  // a single pulverize whose area ≥ HitstopBigArea
    public float HitstopBigArea     { get; set; } = 1400f;
    public float HitstopMax         { get; set; } = 0.13f;  // cap on any single freeze
